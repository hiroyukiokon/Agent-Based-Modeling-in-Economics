...
to setup
  ...
  ; positions of a row of each one of 9 stalls
  ...
  ; [n-shoppers] is defined by the silder on the interface
...
to go
  ...
  ask shoppers with [not empty? shopping-list]
     [
      ; choose a stall form [not-yet-visited] traders
      ...
      ; remember that I have been to this stall,
      ; so I don't come again
      ...
      foreach purchases [ ? ->
          set spent spent + item (position ? [stock] of stall) [ prices ] of stall
